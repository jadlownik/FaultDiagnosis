...
class FaultDiagnosis:
    ...
    def start(self):
        ...
        self._print_service.save_to_csv(
            ...
            f"C:\\Users\\jakto\\Desktop\\Pulpit\\FaultDiagnosis\\FaultDiagnosis\\results_article\\o3_mini\\mso_conflicts_diagnoses\\csv\\{PartEnum(ACTUAL_PART).name}\\result_{timestamp}.csv",
        )
        self._print_service.save_table_to_file(
            self._collected_data,
            f"C:\\Users\\jakto\\Desktop\\Pulpit\\FaultDiagnosis\\FaultDiagnosis\\results_article\\o3_mini\\mso_conflicts_diagnoses\\txt\\{PartEnum(ACTUAL_PART).name}\\result_{timestamp}.txt",
        )
        self._print_service.save_array_to_file(
            self._raw,
            f"C:\\Users\\jakto\\Desktop\\Pulpit\\FaultDiagnosis\\FaultDiagnosis\\results_article\\o3_mini\\mso_conflicts_diagnoses\\raw\\{PartEnum(ACTUAL_PART).name}\\result_{timestamp}.txt",
        )
        self._print_service.save_array_to_file(
            self._raw_messages,
            f"C:\\Users\\jakto\\Desktop\\Pulpit\\FaultDiagnosis\\FaultDiagnosis\\results_article\\o3_mini\\mso_conflicts_diagnoses\\raw_messages\\{PartEnum(ACTUAL_PART).name}\\result_{timestamp}.txt",
        )
